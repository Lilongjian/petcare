...
<head>
	...
	<!-- Boostrap style -->
	<link rel="stylesheet" type="text/css" href="${ctx}/resources/front/stylesheets/bootstrap.min.css">

	<!-- Theme style -->
	<link rel="stylesheet" type="text/css" href="${ctx}/resources/front/stylesheets/style.css">

	<!-- Reponsive -->
	<link rel="stylesheet" type="text/css" href="${ctx}/resources/front/stylesheets/responsive.css">
...
<body class="header_sticky">
	<div class="boxed">
		...
		<!-- Javascript -->
		<script type="text/javascript" src="${ctx}/resources/front/javascript/jquery.min.js"></script>
		<script type="text/javascript" src="${ctx}/resources/front/javascript/tether.min.js"></script>
		<script type="text/javascript" src="${ctx}/resources/front/javascript/bootstrap.min.js"></script>
		<script type="text/javascript" src="${ctx}/resources/front/javascript/waypoints.min.js"></script>
		<!-- <script type="text/javascript" src="${ctx}/resources/front/javascript/jquery.circlechart.js"></script> -->
		<script type="text/javascript" src="${ctx}/resources/front/javascript/easing.js"></script>
		<script type="text/javascript" src="${ctx}/resources/front/javascript/jquery.flexslider-min.js"></script>
		<script type="text/javascript" src="${ctx}/resources/front/javascript/owl.carousel.js"></script>
		<script type="text/javascript" src="${ctx}/resources/front/javascript/smoothscroll.js"></script>
		<!-- <script type="text/javascript" src="${ctx}/resources/front/javascript/jquery-ui.js"></script> -->
		<script type="text/javascript" src="${ctx}/resources/front/javascript/jquery.mCustomScrollbar.js"></script>
		<script type="text/javascript" src="${ctx}/resources/front/http://ditu.google.cn/maps/api/js?key=AIzaSyBtRmXKclfDp20TvfQnpgXSDPjut14x5wk&region=GB"></script>
	   	<script type="text/javascript" src="${ctx}/resources/front/javascript/gmap3.min.js"></script>
	   	<script type="text/javascript" src="${ctx}/resources/front/javascript/waves.min.js"></script> 
		<script type="text/javascript" src="${ctx}/resources/front/javascript/jquery.countdown.js"></script>

		<script type="text/javascript" src="${ctx}/resources/front/javascript/main.js"></script>
